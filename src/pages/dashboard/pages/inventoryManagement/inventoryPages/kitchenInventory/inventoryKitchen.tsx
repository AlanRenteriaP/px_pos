...
import { AddProductGrid, InventoryGrid } from "../features";
export default function InventoryKitchen(){
    ...
    return (
        <div className="container">
            ...
            <div>
                    <InventoryGrid refresh={refreshData} area={"kitchen"}  toggleRefresh={toggleRefresh}/>
            </div>
            <Drawer anchor="bottom" open={productDrawerOpen} onClose={handleProductDrawerClose} sx={{zIndex:9999999}} variant="temporary">
                <AddProductGrid refresh={refreshData} area={"kitchen"} toggleRefresh={toggleRefresh} />
          </Drawer>
        </div>
    )
}